...
<html>
	...
	<body class="is-preload">
			...
			<div id="wrapper">
				...
				<!-- Header -->
					<header id="header">
						...
						<!-- Logo -->
							<div class="logo">
								<a href="/" class="title"><strong>Hello World</strong> <span class="extra">by Corner</span></a>
							</div>
				...
				<!-- Banner -->
					<section id="banner">
						...
						<!-- One -->
							<article class="full">
								<img href="/resources/images/pic01.jpg" alt="" data-position="center" />
								<div class="content">
						...
						<!-- Two -->
							<article class="half">
								<img href="/resources/images/pic02.jpg" alt="" data-position="center" />
								<div class="content">
						...
						<!-- Three -->
							<article class="half">
								<img href="/resources/images/pic03.jpg" alt="" data-position="center" />
								<div class="content">
					...
					<div id="main">
						...
						<!-- Post -->
							<section class="main special">
								<div class="inner">
									...
									<a href="#" class="image main"><img href="/resources/images/pic04.jpg" alt="" /></a>
						...
						<!-- Posts -->
							<section class="main">
								<div class="posts">
									<article>
										<a href="#" class="image"><img href="/resources/images/pic05.jpg" alt="" /></a>
										<header>
									...
									<article>
										<a href="#" class="image"><img href="/resources/images/pic06.jpg" alt="" /></a>
										<header>
									...
									<article>
										<a href="#" class="image"><img href="/resources/images/pic07.jpg" alt="" /></a>
										<header>
									...
									<article>
										<a href="#" class="image"><img href="/resources/images/pic08.jpg" alt="" /></a>
										<header>
									...
									<article>
										<a href="#" class="image"><img href="/resources/images/pic09.jpg" alt="" /></a>
										<header>
									...
									<article>
										<a href="#" class="image"><img href="/resources/images/pic10.jpg" alt="" /></a>
										<header>
		...
		<!-- Scripts -->
			<script href="/resources/assets/js/jquery.min.js"></script>
			<script href="/resources/assets/js/jquery.dropotron.min.js"></script>
			<script href="/resources/assets/js/browser.min.js"></script>
			<script href="/resources/assets/js/breakpoints.min.js"></script>
			<script href="/resources/assets/js/util.js"></script>
			<script href="/resources/assets/js/main.js"></script>
