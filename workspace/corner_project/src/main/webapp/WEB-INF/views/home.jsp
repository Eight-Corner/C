...
<html>
	<head>
		...
		<link rel="shortcut icon" type="image/x-icon" href="/resources/images/y_title_icon.ico">
	</head>
					...
					<!-- Post -->
						<section class="main special">
							<div class="inner">
								...
								<a href="#" class="image main"><img src="/resources/images/bg/bg4.jpg" alt="" /></a>
					...
					<!-- Posts -->
						<section class="main">
							<div class="posts">
								...
								<article>
									<a href="#" class="image"><img src="/resources/images/bg/bg6.jpg" alt="" /></a>
									<header>
