...
<p></p>
<form name="joinForm" action="/account/signup" method="post" >
    <div class="row gtr-uniform">
        <div class="col-6 col-12-xsmall" style="margin: 0 auto;">
           ...
           <br>
			...
			<td>
            <input type="email" name="emailAddress" style="width:77%; float:left" placeholder="abc@gmail.com" />
             <a href="javascript:EmailCheck();" class="button primary"
             type="submit" style="float:left;">
             인증번호 전송</a>
             <br><br>
             <div class="mail_verify_input_box" id="mail_verify_input_box_false">
             <input type="text" name="verify" id="verify" class="verify" style="width:77%; float:left" placeholder="7자리" disabled="disabled" />
             <a href="javascript:verifyCheck();" class="button primary"
              type="submit" style="float:left;">
             인증번호 확인</a>
             </div>
...
본 약관은 2020년 11월 16일부터 적용하고, 2016년 5월 2일부터 시행되던 종전의 약관은 본 약관으로 대체합니다.
    ...
    <div class="col-12">
        ...
        <ul class="actions">
            ...
            <a href="javascript:formSubmit()" class="button" type="submit">가입하기</a>
            </li>
        </ul>
    </div>
</form>
...
<script src="/resources/assets/js/account/join.js"></script>
</body>
</html>